...
public class FixedFrequencyFlushSignal implements FlushSignal {
  ...
  public void update(long timestamp) {
    ...
    //LOG.debug("'{}' ms until flush; minTime={}, currentTime={}, maxTime={}, flushTime={}",
      //      Math.max(0, minTime + flushFrequency - maxTime), minTime, timestamp, maxTime, minTime + flushFrequency);
  }
