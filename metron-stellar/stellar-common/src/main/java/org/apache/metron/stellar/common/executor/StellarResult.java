...
public class StellarResult<T> {
   ...
   */
  private StellarResult(Status status, T value) {
    this.status = status;
   ...
   */
  public static <T> StellarResult<T> success(T value) {
   ...
   */
  public static <T> StellarResult<T> error(Throwable exception) {
   ...
   * @return A Result indicating that an error occurred.
   */
  public static <T> StellarResult<T> error(String errorMessage) {
   ...
   */
  public static <T> StellarResult<T> noop() {
   ...
   */
  public static <T> StellarResult<T> terminate() {
